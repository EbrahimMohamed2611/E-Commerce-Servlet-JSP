    ...
    <script>
        ...
        function handleStateChange() {
            ...
            if (xmlHttp.readyState === 4 && xmlHttp.status === 200) {
                ...
                document.getElementById("balance").style.backgroundColor = "#6c757d";
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="checkout-form-list">
                            ...
                            <input style="background-color: #6c757d" readonly type="text" class="form-control" name="firstName"
                                   id="firstName" value="${sessionScope.userDto.firstName}"
                    ...
                    <div class="col-md-6">
                        <div class="checkout-form-list">
                            ...
                            <input readonly style="background-color: #6c757d" name="phoneNumber" type="text" class="form-control"
                                   ...
                                   title="Invalid phone number" onblur="checkphone()" value="${sessionScope.userDto.phone}">
                    ...
                    <div class="form-group col-md-6">
                        <div class="checkout-form-list">
                            ...
                            <label id="codelabel2" style="color:red" hidden>Enter a zip code in right formate</label>
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group col-md-6">
                        <div class="checkout-form-list">
                            ...
                            <input readonly style="background-color: #6c757d" name="balance" type="number" class="form-control"
                                   id="balance"
                                   onblur="checkbalance()"
