...
">Home Two</a></li>
                                                    <li class="active"><a href="index-3.jsp
">Home Three</a></li>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="category-menu category-menu-2">
                                ...
                                <div id="cate-toggle" class="category-menu-list">
                                    <ul>
                                        <li class="right-menu"><a href="shop-left-sidebar.jsp
">Laptops</a>
...
">Studio Design</a>
                                                    ...
                                                    <h4><a class="featured-product-name" href="single-product.jsp
">Mug Today is a good day</a></h4>
                                                    ...
                                                    <div class="featured-product-action">
                                                        <ul class="add-actions-link">
                                                            <li class="add-cart active"><a href="#">Add to cart</a></li>
                                                            <li><a class="links-details" href="single-product.jsp
"><i class="fa fa-heart-o"></i></a></li>
