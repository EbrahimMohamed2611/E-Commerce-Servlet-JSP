    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 card" >
              ...
              <span>
                <img
                        src="images/shipping-icon/order-done.svg"
                        alt="completed order"
                        style="width: 3vw"
                />
              </span>
                    ...
                    <div class="col-sm-12 text-center" style="width: 10vw">
                        <img
                                src="images/shipping-icon/complete-order.png"
                                alt="completed order"
                                style="width: 10vw"
                        />
                    </div>

                    <div class="col-sm-12 text-center mt-5" style="width: 10vw">
                        <div class="alert alert-info">
                            <h5>
                                Thanks for use our service Please check your mail to track
                                your order status
                            </h5>
                        </div>
                    </div>
