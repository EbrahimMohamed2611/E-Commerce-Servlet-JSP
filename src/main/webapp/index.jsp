...
<div class="body-wrapper">
    ...
    <%--            <div class="container">--%>
    <%--                <div class="row">--%>
    <%--                    &lt;%&ndash;                            ${sessionScope.userDto.userId}&ndash;%&gt;--%>
...
">
                ...
                <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                    ...
                    <form action="products" class="hm-searchbox">
                        <select name="cat" id="categoriesContainer" class="nice-select select-search-category">
                                    ...
                                    <ul id="shoppingCardContainer" class="minicart-product-list">
                                        <c:if test="${not empty sessionScope.userNotCompletedOrders}">
                                            <c:forEach items="${sessionScope.userNotCompletedOrders[0].itemsOrdered}"
                                                       var="item">
                                                <li>
                                                    <a href="productInfo?productId=${item.orderedProductDTO.productId}" class="minicart-product-image">
                                                        <img src="${item.orderedProductDTO.productImage.imagePath}" alt="cart products">
                                                    </a>
                                                    <div class="minicart-product-details">
                                                        <h6><a href="productInfo?productId=${item.orderedProductDTO.productId}">${item.orderedProductDTO.productName}</a></h6>
                                                        <span>$${item.orderedProductDTO.price}</span>
                                                    </div>
                                                    <button class="close removeFromCart" title="Remove" data-product="${item.orderedProductDTO.productId}" onclick="removeElement(this)">
                            ...
                            <div class="single-slide align-center-left  animation-style-01 bg-1">
                                ...
                                <div class="slider-content">
                                    ...
                                    <div class="default-btn slide-btn">
                                        <a class="links" href="shop-left-sidebar.jsp
">Shopping Now</a>
                                    </div>
                                </div>
                            </div>
...
">Accusantium dolorem1</a></h4>
                                        ...
                                        <div class="add-actions">
                                            <ul class="add-actions-link">
                                                ...
                                                <li><a class="links-details" href="wishlist.jsp
                ...
                <div class="col-lg-12">
                    <div class="li-section-title">
                        ...
                        <ul class="li-sub-category-list">
                            <li class="active"><a href="shop-left-sidebar.jsp
">Prime Video</a></li>
                            <li><a href="shop-left-sidebar.jsp
">Computers</a></li>
                            <li><a href="shop-left-sidebar.jsp
                            ...
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <div class="product-additional-info pt-25">
                                        <a class="wishlist-btn" href="wishlist.jsp
