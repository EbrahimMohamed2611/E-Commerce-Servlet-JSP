                                    ...
                                    <ul id="shoppingCardContainer" class="minicart-product-list">
                                        <c:if test="${not empty sessionScope.userNotCompletedOrders}">
                                            <c:forEach items="${sessionScope.userNotCompletedOrders[0].itemsOrdered}"
                                                       var="item">
                                                <li>
                                                    <a href="productInfo?productId=${item.orderedProductDTO.productId}"
                                                    ...
                                                    <div class="minicart-product-details">
                                                        <h6>
                                                            <a href="productInfo?productId=${item.orderedProductDTO.productId}">${item.orderedProductDTO.productName}</a>
                                                        </h6>
                                                        <span>$${item.orderedProductDTO.price}</span>
                                                    </div>
                                                    <button class="close removeFromCart" title="Remove"
                ...
                <div class="col-lg-3">
                    ...
                    <div class="category-menu">
                        ...
                        <div id="cate-toggle" class="category-menu-list">
                            <ul id="detailedCategoryContainer">
...
<!-- category js -->
<script src="js/ajax-detailedCategory.js"></script>
</body>
