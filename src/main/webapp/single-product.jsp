...
">Single Products</a>
                                                <ul>
                                                    <li class="active"><a href="single-product.jsp
">Single Product</a></li>
                    ...
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            ...
                            <div class="price-box pt-20">
                                <span class="new-price new-price-2">$${requestScope.product.price}</span>
                            </div>
                ...
                <div id="reviews" class="tab-pane" role="tabpanel">
                    <div class="product-reviews">
                        <div class="product-details-comment-block">
                            <c:forEach items="${requestScope.product.reviews}" var="review">
                                <div class="comment-review">
                                    <span>Grade</span>
                                    <ul id="starsContainer" class="rating">
                                        <script>
                                            let starCounts = ${review.stars};
                                            let starContainer = document.querySelector("#starsContainer");
                                            for (let i = 0; i < 5; i++) {
                                                if (i < starCounts) {
                                                    starContainer.innerHTML += '<li><i class="fa fa-star-o"></i></li>';
                                                } else {
                                                    starContainer.innerHTML += '<li class="no-star"><i class="fa fa-star-o"></i></li>';
                                                }
                                            }
                                        </script>
                                    </ul>
                                ...
                                <div class="comment-details">
                                    <h4 class="title-block">Message</h4>
                                    <p>${review.message}</p>
                                </div>
                            </c:forEach>
