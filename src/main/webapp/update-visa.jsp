...
">Accessories</a></li>
    ...
    <div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0">
        <div class="container" style="margin:150px auto">
            <c:if test="${param.balanceUpdated != null}">
    ...
    margin-top: -173px;
">
                    Thank you you can now complete your purchase
                </div>
            </c:if>
            <div class="row content-parent justify-content-center align-items-center">
                <div class="col-md-6">
                            ...
                            <div class="front">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <img src="./assets/card_bank.png" width="50" style="filter: contrast(0)"
                                             height="50" alt="">
                    ...
                    <form action="updateVisa" method="POST">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="" class="form-control card-input_field"
                                                    id="monthInput">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="" class="form-control card-input_field mt-2"
                                                    id="yearInput">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control card-input_field"
                                                   id="cwInput">
                                        </div>
                                    </div>

                                </div>
                                <button type="submit" class="btn btn-primary w-100">Update My Balance</button>
                            </div>
                        </div>
                    </form>
                </div>
